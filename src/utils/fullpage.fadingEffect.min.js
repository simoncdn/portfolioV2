...
/* eslint-disable */ window.fp_fadingEffectExtension = function () {
  var n,
    ...
    T = '#' + S
  function x(t) {
    t.detail ? ((r = !1), L()) : ((r = a.autoScrolling), _())
  }
  function O() {
    var t
    ;(t = f(u)[0]).addEventListener('afterResponsive', x), t.addEventListener('destroy', L)
    var e = c.scrollOverflowHandler
    ;(c.scrollOverflowHandler = null),
      (a = l.deepExtend({}, c)),
      (r = a.autoScrolling),
      (c.scrollOverflowHandler = e),
      (a.scrollOverflowHandler = e),
      (c.scrollBar = !1),
      b('sections') && s.setAutoScrolling(!0)
    var n = b('slides') ? H(g) : '',
      i = b('sections') ? H(m) : ''
    c.fadingEffect && A(S, i + n),
      d.removeAnimation(f(w)),
      clearTimeout(o),
      (o = setTimeout(z, 300))
  }
  function b(t) {
  ...
  function z() {
    n = 'all ' + i + 'ms ' + c.easingcss3
    var t = b('slides') ? B(g) : '',
      e = b('sections') ? B(m) : ''
    A(h, t + e)
  }
  function B(t) {
    return t + '{-webkit-transition: ' + n + ';transition: ' + n + ';transform: translatez(0);}'
  }
  function H(t) {
    return (
      (t === g
        ? '.fp-slidesContainer {width: 100% !important;transform: none!important;transition: none !important;transform: translatez(0);}'
        : u + '{transition: none !important;transform: translatez(0);}') +
      t +
  ...
  function L() {
    if ((l.remove(f(y)), C())) {
      ...
      d.removeAnimation(e),
        ...
        s.setAutoScrolling(r),
        null != t && d.silentLandscapeScroll(t)
    }
  }
  function C() {
    return f(T).length
  ...
  function _() {
    ;(c.fadingEffect = a.fadingEffect), C() || (O(), window.scrollTo(0, 0), d.silentScroll(0))
  }
  ;(t.update = function (t) {
    l.remove(f(y)), (i = t), z()
  }),
    ...
    (t.apply = O),
    (t.c = d.c)
  var N = t['common'.charAt(0)]
  return (
    'complete' === document.readyState && N('fadingEffect'),
